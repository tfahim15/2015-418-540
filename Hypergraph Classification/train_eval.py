...
import math
import time
freq = open("cover_freq_.txt").readlines()
file_name = "dd"
...
out = open("time.txt", "a")
out.write("\n"+str(filter_time/600)+"\n")
out.write(str(embedding_time/600)+"\n")
out.close()